...
% personal data
\name{Karthik}{R. Padmanabhan, Ph.D.}
...
{-  Bioinformatics Analyst with 9 years of hands-on experience in development of next-gen sequencing pipelines \\
...
{\customcvproject{Languages/Pipeline Development}{}
{- R, Python, Perl, JavaScript, Snakemake, Docker, Singularity, slurm, Torque, version control (CVS, git),  Jupyter Notebook}
}
