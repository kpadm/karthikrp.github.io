...
- Developed and maintained pipelines and software to aid design of new products in R\&D using Python, Docker, Shiny and JavaScript
}
...
{- Developed, tested and maintained bioinformatics pipelines using Snakemake, R, Python, and open-source bioinformatics tools\\
  ...
  - Organized pre- and post-analysis consultations, generated detailed analysis reports and interpreted results effectively to non-expert audiences
}
}

{\customcventry{West Lafayette, IN}{Purdue University}{Research Assistant}{Aug 2012 - Jul 2016}{}
{- Analyzed NGS data (\textit{de novo} transcriptome analysis) from giant ragweed to identify genes responsible for disease resistance\\
  - Performed domain co-occurrence analysis using statistical models for identifying the pairwise probability of protein domains to understand early land plant evolution}
}
